...
import { expo as appParams, shareExtName } from '../../app.json'
import {
    createMainNavigator,
...
export class UI {
    ...
    constructor() {
            ...
            () =>
                class extends Component<{}, CoreUIState> {
                    ...
                    async componentDidMount() {
                        ...
                        const user =
                            await dependencies.services.auth.getCurrentUser()
        ...
        AppRegistry.registerComponent(
            appParams.name,
            setupContainerComponent(createMainNavigator, appParams.name),
        )
