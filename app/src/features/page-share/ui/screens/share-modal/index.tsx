...
export default class ShareModalScreen extends StatefulUIElement<Props, State, Event> {
    ...
    render() {
      return (
        <ShareModal isModalShown={this.state.isModalShown} onClosed={this.handleClose}>
          <ActionBar
          ...
          <NoteInput
            onChange={value => this.processEvent('setNoteText', { value })}
            value={this.state.noteText}
          />
          <StarPage
            isStarred={this.state.isStarred}
            onPress={e => this.processEvent('setPageStar', { value: !this.state.isStarred })}
          />
          <AddCollection
